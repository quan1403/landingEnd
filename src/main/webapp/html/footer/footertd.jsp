...
<%--                                &lt;%&ndash;                                        <option value="MobiFone Smart Sales">MobiFone Smart Sales</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MobiFone Smart Office">MobiFone Smart Office</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MobiFone Voice Brandname">MobiFone Voice Brandname</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MobiFone SIP Trunk">MobiFone SIP Trunk</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MobiFone eKYC">MobiFone eKYC</option>&ndash;%&gt;--%>
...
<%--                                &lt;%&ndash;                                        <option value="mTracker">mTracker</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Giải pháp quản lý thông tin Nguồn thông minh">Giải pháp quản lý thông tin Nguồn thông minh</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="AI Social Monitoring">AI Social Monitoring</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Truyền thanh thông minh">Truyền thanh thông minh</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Hệ thống quản lý tài liệu điện tử">Hệ thống quản lý tài liệu điện tử</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Hệ thống Cổng thông tin điện tử">Hệ thống Cổng thông tin điện tử</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Hệ thống cơ sở dữ liệu thông tin KT – XH">Hệ thống cơ sở dữ liệu thông tin KT – XH</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Hệ thống Giám sát điện thoại viên">Hệ thống Giám sát điện thoại viên</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Giải pháp phần mềm một cửa điện tử liên thông e-Gate">Giải pháp phần mềm một cửa điện tử liên thông e-Gate</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MobiFone BMCC gateway">MobiFone BMCC gateway</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MobiFone Smart Travel">MobiFone Smart Travel</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MobiFone Spam Call Prevention">MobiFone Spam Call Prevention</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="mAI Call Center">mAI Call Center</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="MOBIFONE.AI – Trợ lý ảo">MOBIFONE.AI – Trợ lý ảo</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="AI Camera">AI Camera</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="AIOCR">AIOCR</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Lưu trữ số hóa điện tử tập trung trên nền tảng Big Data">Lưu trữ số hóa điện tử tập trung trên nền tảng Big Data</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Nền tảng tích hợp, chia sẻ dữ liệu cấp Bộ, cấp tỉnh">Nền tảng tích hợp, chia sẻ dữ liệu cấp Bộ, cấp tỉnh</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Cổng dịch vụ công mức độ 3, 4">Cổng dịch vụ công mức độ 3, 4</option>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <option value="Hệ thống Quản lý cán bộ công chức, viên chức">Hệ thống Quản lý cán bộ công chức, viên chức</option>&ndash;%&gt;--%>
<%--                            </select>--%>
